        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_curriculums_departments_department_id",
                        column: x => x.department_id,
                        principalTable: "departments",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_curriculums_users_created_by",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_roles", x => new { x.user_id, x.role_id, x.department_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    curriculum_id = table.Column<int>(type: "integer", nullable: true),
                    is_ocr_required = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_documents_curriculums_curriculum_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_documents_users_approved_by",
            ...
            migrationBuilder.CreateTable(
                name: "ai_knowledge_conflicts",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    source_document_id = table.Column<int>(type: "integer", nullable: false),
                    conflicting_document_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ai_knowledge_conflicts", x => x.id);
                    table.ForeignKey(
                        name: "FK_ai_knowledge_conflicts_documents_conflicting_document_id",
                        column: x => x.conflicting_document_id,
                        principalTable: "documents",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ai_knowledge_conflicts_documents_source_document_id",
                        column: x => x.source_document_id,
                        principalTable: "documents",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ai_knowledge_conflicts_users_resolved_by",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ai_knowledge_conflicts_conflicting_document_id",
                table: "ai_knowledge_conflicts",
                column: "conflicting_document_id");

            migrationBuilder.CreateIndex(
                name: "IX_ai_knowledge_conflicts_resolved_by",
                table: "ai_knowledge_conflicts",
                column: "resolved_by");

            migrationBuilder.CreateIndex(
                name: "IX_ai_knowledge_conflicts_source_document_id",
                table: "ai_knowledge_conflicts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_curriculums_created_by",
                table: "curriculums",
                column: "created_by");

            migrationBuilder.CreateIndex(
                name: "IX_curriculums_department_id",
                table: "curriculums",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_documents_approved_by",
                table: "documents",
                column: "approved_by");

            migrationBuilder.CreateIndex(
                name: "IX_documents_curriculum_id",
                table: "documents",
